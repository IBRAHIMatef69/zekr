  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView.builder(
          ...
          itemCount: controller.sleepZekrScreen.length == 0
              ? 0
              : controller.sleepZekrScreen.length,
          itemBuilder: (_, index) {
            return GetBuilder<OutHomeController>(
              builder: (_) {
                return UnCounted(
                    zekrBody: controller.sleepZekrScreen[index].zekr.toString(),
                    category:
                        controller.sleepZekrScreen[index].category.toString());
              },
            );
          },
        ));
